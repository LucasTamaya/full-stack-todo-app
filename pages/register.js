...
export default function Register() {
  ...
  const validationSchema = Yup.object({
    ...
    name: Yup.string()
      .min(2, "This name is too short") //message d'erreur si le nom n'est pas valide
      .required("You must enter your email address"), //message d'erreur si on ne remplit pas le champ nom
    password: Yup.string()
